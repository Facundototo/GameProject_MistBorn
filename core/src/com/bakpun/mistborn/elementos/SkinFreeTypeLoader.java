...
public class SkinFreeTypeLoader {

	//Clase que tiene como funcion retornar una skin que tiene dentro el codigo para usar FreeTypeFont en Scene2DUI.
	
	private static Skin skin;
	
	public static Skin cargar() {
