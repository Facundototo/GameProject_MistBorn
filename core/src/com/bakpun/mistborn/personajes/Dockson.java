...
public final class Dockson extends Personaje{
	...
	public Dockson(Entradas entradas,Spawn spawn,TipoCliente tipoCliente) {
		super(Recursos.PERSONAJE_HAM,Recursos.SALTOS_HAM,Recursos.ANIMACIONES_ESTADOS_HAM,entradas, spawn,tipoCliente,TipoPersonaje.LANZAMONEDAS);
	}
