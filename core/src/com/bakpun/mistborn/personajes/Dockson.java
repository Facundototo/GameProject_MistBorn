...
public final class Dockson extends Personaje{
	...
	public Dockson(World mundo, Entradas entradas,Colision c,OrthographicCamera cam,Spawn spawn,TipoCliente tipoCliente) {
		super(Recursos.PERSONAJE_HAM,Recursos.SALTOS_HAM,Recursos.ANIMACIONES_ESTADOS_HAM, mundo, entradas, c, cam, spawn,tipoCliente,TipoPersonaje.LANZAMONEDAS);
	}
